...
const quizArray = [
  {
    id: "0",
    question: "Which of the following is not css selector which is used to 'find' the html elements we want to style?",
    options: ["Complex Selectors", "Combinator Selectors", "Pseudo-element Selectors", "Simple Selectors"],
